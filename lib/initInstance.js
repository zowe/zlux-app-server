...
const workspaceLocation = process.env.WORKSPACE_DIR && process.env.WORKSPACE_DIR != '""'
      ? process.env.WORKSPACE_DIR
      : process.env.ZWE_zowe_workspaceDirectory && process.env.ZWE_zowe_workspaceDirectory != '""'
      ? process.env.ZWE_zowe_workspaceDirectory
      : path.join(process.env.HOME, '.zowe', 'workspace');
