      ...
      if (process.env['ROOT_DIR']) {
        ...
        filtered.forEach((file)=> {
          try {
            ...
            let componentIndex = pluginJson.pluginLocation.indexOf('components/app-server');
            if (componentIndex == -1) {
              componentIndex = pluginJson.pluginLocation.startsWith('/component/share') ? 0 : -1;
              if (componentIndex == -1) {
                componentIndex = pluginJson.pluginLocation.startsWith('../../') ? 6 : -1;
              }
            }
            if (componentIndex != -1) {
